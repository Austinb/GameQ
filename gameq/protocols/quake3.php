...
class GameQ_Protocols_Quake3 extends GameQ_Protocols
{
    ...
    protected function preProcess_status($packets)
    {
    	...
    	if (count($packets) > 1)
    	{
    		throw new GameQException('Quake 3 status has more than 1 packet');
    	}
    	...
    	{
    		throw new GameQException('Unable to match Gamespy 3 challenge response header. Header: '. $header);
    		return FALSE;
    	}
